<!-- Mengyuan Huang
	 CSE 154 AJ HW4
	 This is the common page containing any common code used by the above pages.-->
<!DOCTYPE html><!--For common header-->
<html>
	<head>
...
<?php function commonBottom(){ /*This is the function for bottom pictures and links */?>
		<div>
			<p>
